# TFM: Sistema wearable IoT basado en Edge AI para la monitorización de saltos en voleibol

**Autor:** Carlos Zarza Martín del Campo  
**Institución:** Universidad de Málaga (UMA)  

Este repositorio contiene el código fuente, la documentación y los archivos de validación del Trabajo de Fin de Máster: Sistema wearable IoT basado en Edge AI para la monitorización de saltos en voleibol.
